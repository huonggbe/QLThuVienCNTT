									...
									<div class="single-log-info">
										<div class="bulling-title">
											<b>
												...
												?>
													<div class="alert  <?php echo str_contains($_COOKIE['doimk'], 'thành công') ? 'alert-success' : 'alert-danger' ?>">
											...
											<div class="custom-input">
												<form action="?act=taikhoan&xuli=update" method="post">
													...
													<input type="text" name="SĐT" placeholder="Số điện thoại.." required pattern='0[0-9]{9}' maxLength='10' value="<?= $data['SDT'] ?>" />
													<input type="text" name="DiaChi" placeholder="Địa chỉ.." value="<?= $data['DiaChi'] ?>" />
							...
							<li class="panel">
								...
								<div id="collapse4" class="panel-collapse collapse">
									<div class="single-log-info">
										<div class="custom-input">
											<form action="?act=taikhoan&xuli=update" method="post">
												<input type="password" placeholder="Mật khẩu hiện tại .. " name="MatKhau" minlength="5" required />
												<input type="password" placeholder="Mật khẩu mới .. " name="MatKhauMoi" minlength="5" />
												<input type="password" placeholder="Xác nhận lại mật khẩu .." name="MatKhauXN" minlength="5" />
