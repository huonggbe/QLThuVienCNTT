 ...
 <div class="container">
 	<form id="mocform" action="" method="GET">
 				...
 				<div class="col-md-12">
 					<div class="form-group">
 						...
 						<select class="form-control" id="thongke" name="thongke">
 							<option value="docgia">Độc giả mượn sách</option>
 							<option value="sachmuon">Tài liệu đang được mượn</option>
 ...
 <?php if (isset($_GET['tke'])) {
	?>
 	...
 	<body>
 		...
 		<a href="?mod=login&act=xuat&tke&thongke=<?= $_GET['thongke'] ?>&mauthongke=<?= $mauthongke ?>" class="btn btn-primary my-custom-class" style="width:fit-content; margin: 12px auto;display:block "> Xuất</a>
 	<?php } ?>
 	<style>
 		.my-custom-class {
