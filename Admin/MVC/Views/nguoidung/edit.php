...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=nguoidung&act=update" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
               <label for="">Họ</label>
               <input type="text" class="form-control" required id="" placeholder="" name="Ho" value="<?= $data['Ho']?>">
           </div>
           <div class="form-group">
               <label for="">Tên</label>
               <input type="text" class="form-control" required id="" placeholder="" name="Ten" value="<?= $data['Ten']?>">
           </div>
           <div class="form-group">
               <label for="">Tên Tài Khoản</label>
               <input type="text" class="form-control" required id="" placeholder="" name="TaiKhoan" value="<?= $data['TaiKhoan']?>">
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
               ...
               <input type="text" class="form-control" required pattern="0[0-9]{9}" maxLength="10" id="" placeholder="" name="SDT" value="<?= $data['SDT']?>">
           </div>
           
           
           <div class="form-group">
               <label for="">Trạng Thái</label>
               <input type="text" class="form-control" required id="" placeholder="" name="TrangThai" value="<?= $data['TrangThai']?>">
           </div>
           <div class="form-group">
               <label for="">Email</label>
               <input type="Email" class="form-control" required id="" placeholder="" name="Email" value="<?= $data['Email']?>">
           </div>
           <div class="form-group">
           <div class="form-group">
