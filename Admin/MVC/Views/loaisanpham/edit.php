...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=loaitailieu&act=update" method="POST" role="form" enctype="multipart/form-data">
        <input type="hidden" name="MaTaiLieu" value="<?= $data_detail['MaTaiLieu'] ?>">
        <div class="form-group">
            <label for="">Tên loại tài liệu</label>
            <input type="text" class="form-control" id="" placeholder="" name="TenLoaiTaiLieu" value="<?= $data_detail['TenLoaiTaiLieu'] ?>">
        </div>
        <div class="form-group">
