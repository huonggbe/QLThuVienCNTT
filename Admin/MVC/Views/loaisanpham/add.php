<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <?php } ?>
    <form action="?mod=loaitailieu&act=store" method="POST" role="form" enctype="multipart/form-data">
        <div class="form-group">
            <label for="">Tên loại tài liệu</label>
            <input type="text" class="form-control" id="" placeholder="" name="TenLoaiTaiLieu">
        </div>
        <div class="form-group">
